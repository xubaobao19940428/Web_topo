<template>
<div class="wresize-panel-3" @touchend="onMouseup($event)" @touchmove="onMousemove($event)" @mouseup="onMouseup($event)" @mousemove="onMousemove($event)">

    <div class="wresize-panel-left" :style="{width: divLeft.width + 'px'}">
        <slot name="left"></slot>
    </div>

    <div class="wresize-handler-left" @touchstart="onMouseDownLeft($event)" @mousedown="onMouseDownLeft($event)" :style="{left: divLeftHandler.left + 'px'}"></div>

    <div class="wresize-panel-center" :style="{left: divCenter.left + 'px', right: divCenter.right + 'px'}">
        <slot name="center"></slot>
    </div>

    <div class="wresize-handler-right" @touchstart="onMouseDownRight($event)" @mousedown="onMouseDownRight($event)" :style="{right: divRightHandler.right + 'px'}"></div>
