  ...
  switch (command.op) {
    case "add":
      ...
      component.style.borderColor = component.style.borderColor
        ...
        : "#ccccccff";
      component.style.url = component.style.url
      //额外的参数配置物模型以及网关设备
      component.wumoxing.identifier=''
      component.wumoxing.name=''
      component.wumoxing.max=''
      component.wumoxing.min=''
      component.wumoxing.unit=''
      component.wumoxing.value=''
      component.handle=''
      component.productId=''
